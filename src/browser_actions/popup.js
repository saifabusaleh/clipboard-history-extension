...
const deleteSvg = `<svg height="16" viewBox="0 0 16 16" version="1.1" width="16" aria-hidden="true">
                        <path
...
const addClip = (clip) => {
    ...
    // Creating the svg icon node for the button
    var deleteSvgWrapper = document.createElement('span');
    deleteSvgWrapper.innerHTML = deleteSvg;
    deleteButton.appendChild(deleteSvgWrapper);
